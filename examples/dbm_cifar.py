...
from boltzmann_machines.rbm.rbm import GaussianRBM, MultinomialRBM

from boltzmann_machines.utils.stopwatch import Stopwatch
from boltzmann_machines.utils.rng import RNG
from boltzmann_machines.utils.utils import one_hot, one_hot_decision_function, unhot
...
def make_mlp(train, val, test, W, args):
